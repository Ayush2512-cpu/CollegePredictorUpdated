...
public class CollegePopulatorAdvance {
    ...
    private static final String state[] = {"Maharashtra","New Delhi",
            "Uttar Pradesh","West Bengal","Tamil Nadu","Uttarakhand","Odisha","Gujarat","Hyderabad","Jharkhand","Madhya Pradesh","Himachal Pradesh","Bihar","Punjab","Assam","Kerala","Andhra Pradesh","Jammu & Kashmir","Goa","Rajasthan","Manipur","Meghalaya","Tripura","Arunachal Pradesh","Chhatisgarh","Karnataka","Telangana","Haryana"};

    private static final String college[] = {"IIT Bombay", "IIT Delhi", "IIT Kanpur", "IIT Kharagpur", "IIT Madras", "IIT Roorkee", "IIT BHU", "IIT Bhubaneswar", "IIT Gandhinagar", "IIT Hyderabad", "IIT Dhanbad", "IIT Indore", "IIT Mandi", "IIT Patna", "IIT Ropar", "IIT Guwahati", "IIT Palakkad", "IIT Tirupati", "IIT Jammu", "IIT Goa", "IIT Jodhpur"};
    private static final String nrif[] ={"3","2","4","5","1","6","11","22","24","8","12","10","31","26","25","7","-1","-1","-1","-1","53"};
    ...
    private static final int general[][] = {{1739, 1940, 3430, 3516, 3308, 4384, 6421, 0, 6671, 5923, 8743, 0, 0, 10497, 8692, 5697, 0, 11424, 12057, 0},
    ...
    public static final String type = "advance";
