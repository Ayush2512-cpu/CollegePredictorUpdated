...
public class Trym {
    ...
    private String state[] = {"Tamil Nadu","Odisha","Karnataka","Telangana","Uttar Pradesh","Maharashtra","Kerala","Gujarat","Assam","West Bengal","Himachal Pradesh","Haryana","Madhya Pradesh","Rajasthan","Manipur","Meghalaya","Tripura","Andhra Pradesh","Arunachal Pradesh","Chhatisgarh","New Delhi"};
    private String nrif[] ={"9","16","13","19","48","27","23","54","46","47","NA","40","65","35","158","61","75","NA","NA","NA","NA"};
    ...
    public ArrayList<String>[] gcheck(int a, int r) {
        ...
        al[2] = list3;
        al[3] = list4;
        int b[][] = {{0, 18067, 13820, 14401, 0, 0, 23362, 0, 23698,27965,30991, 0, 0, 0, 0,0, 0,36412,0,0},
    ...
    public ArrayList<String>[] ocheck(int a, int r) {
        ...
        al[2] = list3;
        al[3] = list4;
        int b[][] = {{0, 20067, 16820, 16401, 0, 0, 25362, 0, 25698,29965,33991, 0, 0, 0, 0,0, 0,38412,0,0},
    ...
    public ArrayList<String>[] scheck(int a, int r) {
        ...
        al[2] = list3;
        al[3] = list4;
        int b[][] = {{0, 22067, 19820, 19401, 0, 0, 27362, 0, 29698,30965,35991, 0, 0, 0, 0,0, 0,40412,0,0},
